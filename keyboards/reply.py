...
from data.constants import MenuKeys, AdminKeys
...
def get_main_menu_keyboard(lang: str, is_admin: bool = False) -> ReplyKeyboardMarkup:
    keyboard = [
        ...
        [KeyboardButton(text=I18N.get(MenuKeys.ORDERS, lang)), KeyboardButton(text=I18N.get(MenuKeys.SEARCH, lang))],
        [KeyboardButton(text=I18N.get(MenuKeys.SETTINGS, lang)), KeyboardButton(text=I18N.get("btn_about", lang))]
    ]
    
    if is_admin:
        keyboard.append([KeyboardButton(text=I18N.get(AdminKeys.STATS, lang)), KeyboardButton(text=I18N.get(AdminKeys.MAILING, lang))])
        keyboard.append([KeyboardButton(text=I18N.get(AdminKeys.ADD_PRODUCT, lang)), KeyboardButton(text=I18N.get(AdminKeys.CATEGORIES, lang))])
        keyboard.append([KeyboardButton(text=I18N.get(AdminKeys.EXPORT_USERS, lang)), KeyboardButton(text=I18N.get(AdminKeys.EXPORT_ORDERS, lang))])
...
def get_cart_keyboard(lang: str) -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text=I18N.get(MenuKeys.CHECKOUT, lang))],
            [KeyboardButton(text=I18N.get("btn_cart_delete", lang))],
            [KeyboardButton(text=I18N.get(MenuKeys.CLEAR_CART, lang))],
            [KeyboardButton(text=I18N.get(MenuKeys.BACK, lang))]
        ],
        resize_keyboard=True
    )
...
def get_admin_cancel_keyboard(lang: str) -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[
            [KeyboardButton(text=I18N.get(AdminKeys.CANCELLED, lang))]
        ],
        resize_keyboard=True
    )
...
def get_contact_keyboard(lang: str) -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[[KeyboardButton(text=I18N.get("share_contact", lang), request_contact=True)]],
        resize_keyboard=True
    )

def get_next_keyboard(lang: str) -> ReplyKeyboardMarkup:
    return ReplyKeyboardMarkup(
        keyboard=[[KeyboardButton(text=I18N.get("admin_btn_next", lang))]],
        resize_keyboard=True
    )
